          ...
          <div className={styles.lcrContent} style={{ color: theme.tertiary }}>
            ...
            <div className={styles.lcrButtonContainer}>
              {headerData.resumePdf && (
                ...
                >
                  <button
                    className="sm:w-[180px] text-[#15202B] 
                                        rounded-[30px] no-underline	w-36 text-base 
                                        font-medium h-12 border-[3px] border-[#6FB3B8] 
                                        transition duration-100 ease-out 
                                        hover:bg-[#BADFE7] hover:text-[#15202B]
                                         hover:border-[#BADFE7] "
                  >
                    Download CV
                  </button>
              ...
              <Link href="/#contacts">
                <button
                  className="sm:w-[180px] bg-[#6FB3B8] 
                                text-[#15202B] rounded-[30px] no-underline	
                                w-36 text-base font-medium h-12 border-[3px]
                                 border-[#6FB3B8] transition duration-100 
                                 ease-out hover:bg-[#BADFE7] hover:text-[#15202B]
                                  hover:border-[#BADFE7] hidden sm:block "
                >
                  Contact
                </button>
              </Link>
