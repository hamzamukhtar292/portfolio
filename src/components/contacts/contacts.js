          ...
          <div className={styles.contactsForm}>
            <form ref={form} onSubmit={handleContactForm}>
              <div className={styles.inputContainer}>
                <label
                  htmlFor="Name"
                  className="bg-[#6FB3B8] text-[#EFF3F4] 
                ...
                <input
                  ...
                  className={`${styles.formInput}  
                                    border-2 border-[#6FB3B8] bg-[#ffffff]
                                     text-[#000000] font-medium transition 
                                     focus:border-[#BADFE7]`}
                />
              </div>
              <div className={styles.inputContainer}>
              ...
              <div className={styles.inputContainer}>
                ...
                <textarea
                  ...
                  className={`${styles.formMessage} 
                                    border-2 border-[#6FB3B8] 
                                    focus:border-[#BADFE7] bg-[#ffffff]
                                     text-[#000000] font-medium transition`}
                />
              </div>
              ...
              <div
                className="w-[45px] h-[45px] 
                            ...
                            ease-in-out text-[#F6F6F2] bg-[#6FB3B8]
                             hover:bg-[#BADFE7] hover:text-[#000000] hover:scale-[1.1] 
                             shrink delay-200"
              >
                <FiAtSign />
              </div>
                ...
                <a
                  ...
                  className="w-[45px] h-[45px] 
                                    rounded-[50%] flex items-center justify-center
                                     text-xl transition ease-in-out text-[#F6F6F2]
                                      bg-[#6FB3B8] hover:bg-[#BADFE7] hover:text-[#000000]"
                >
