        ...
        <div className={styles.projectContent}>
          ...
          <div className={styles.projectShowcaseBtn}>
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="flex items-center justify-center w-[40px] h-[40px] rounded-[50px] border-2 border-[#EFF3F4] hover:border-[#388087] text-[#EFF3F4] hover:text-[#388087] transition hover:scale-[1.1]"
